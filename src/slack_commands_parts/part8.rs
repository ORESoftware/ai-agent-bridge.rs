...
mod command_integration_tests {
    ...
    async fn unauthorized_channel_is_rejected_before_run_claim() {
        ...
        let response = client
            ...
            .await
            .unwrap();
        // An unmapped principal is a policy-boundary rejection, not a
        // human-operational outcome. Keep it distinguishable from an accepted
        // Slack command and do not disclose authorization detail.
